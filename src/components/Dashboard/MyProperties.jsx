  ...
  const fetchProperties = async (page = 1) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Debug: Log the first property to see available fields
        if (actualProperties.length > 0) {
          console.log('Property fields:', Object.keys(actualProperties[0]));
          console.log('First property:', actualProperties[0]);
        }
      ...
      {isLoading ? (
        ...
        <div className={`properties-container ${viewMode}`}>
          ...
          >
            ...
            {/* Property Info */}
            <div className="property-title-container property-info">
            ...
            <button
              ...
              >
                ...
                <span className="btn-text">View Clients</span>
              </button>
        ...
        <div className="preview-modal-overlay" onClick={closePreviewModal}>
          ...
          >
            <div className="preview-modal-header">
              <h2>{selectedProperty.property_number} - {selectedProperty.title}</h2>
              <button
